	...
	<div class="per_login">
		<section class="inner_content">
			...
			<form id="loginform" name="loginform" method="post" action="#">
				<p class="username"><input type="text" name="username" id="username" value="" /></p>
				<p class="pwd"><input type="password" name="password" id="password" value="" /></p>
				<p class="submit_btn"><button id="login_btn">登 录</button></p>
			</form>
		</section>
	</div>

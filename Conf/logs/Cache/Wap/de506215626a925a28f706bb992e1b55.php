            ...
            <article class="f1  bc1">
                <section class="record " style="padding-top: 10px;">
                    ...
                    <dl>
                        <dt class="ul">
                            ...
                            <div class="f1 title2 ul" style="padding-right: 0px;" data-role="boxer">
                                <input class="f1" data-role="boxname" id="Name" name="Name" type="text" value="<?php echo ($insulin["oralmedicine"]); ?>" />
                    ...
                    <dl>
                        ...
                        <dt class="ul">
                            ...
                            <div class="f1 title2">
                                ...
                                <input id="StartTime" name="StartTime" type="hidden" value="<?php echo ($insulin["starttime"]); ?>" />
                            </div>
                        </dt>
                        <dt class="ul">
                            ...
                            <div class="f1 title2">
                                ...
                                <input id="EndTime" name="EndTime" type="hidden" value="<?php echo ($insulin["endtime"]); ?>" />
                            </div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="input">
                                <textarea cols="20" id="Remark" name="Remark" placeholder="今天情况特殊，等等" rows="2"><?php echo ($insulin["note"]); ?>
</textarea>
                            </div>
                        </dd>
                    </dl>

	...
	<div id="wrapper" class="Doctor_personal">
		...
		<ul>
			...
			<a href="<?php echo U('Doctor/custom',array('token'=> $token,'wecha_id'=>$wecha_id));?>">
				<li>我的孕妈:(<?php echo ($doctor["followers"]); ?>个)</li>
			</a>
			...
			<li style="text-align: center;"><a style="color: red; display: block;" href="<?php echo U('Doctor/loginout');?>">退出登陆</a></li>
			<script type="text/javascript">
			    function saveconsult(){
					$.ajax({
						url:'<?php echo U('Doctor/dailyconsult');?>',
...
<footer id="doctor_foot">
	<ul>
		...
		<li>
			<div>
				<a href="<?php echo U('Doctor/custom',array('token'=>$token,'wecha_id'=>$wecha_id));?>" class="iconfont">我的孕妈<?php if(($check) == "1"): ?><span></span><?php endif; ?>
				</a>
			</div>
		</li>

...
<div class="msgWrap">
    <TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
      ...
      <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
        <TR>
          <TH valign="top">
            <label for="keyword">医生照片：</label>
          </TH>
          <TD>
          <?php if(empty($info['pic'])): ?><img style="width: 300px;" src="<?php echo STATICS;?>/images/doctor.jpg" alt="<?php echo ($info["name"]); ?>"><?php else: ?><img style="width: 300px;" src="<?php echo ($info["pic"]); ?>" alt="<?php echo ($info["name"]); ?>"><?php endif; ?>
          </TD>
        </TR>
        <TR>
          <TH valign="top">
        ...
        <TR>
          ...
          <TD>
            <?php echo ($info["followers"]); ?>
          </TD>
        </TR>
        <TR>
          <TH valign="top">
            <label for="keyword">日咨询量：</label>
          </TH>
          <TD>
            <?php echo ($dcnums); ?>
          </TD>
        ...
        <TR>
          <TH valign="top">
            <label for="keyword">总咨询量：</label>
          </TH>
          <TD>
            <?php echo ($info["consultnums"]); ?>
          </TD>
        </TR>
        <TR>
          <TH valign="top">
          ...
          <TD>
            <style>
              ...
              #cztable tr td[data-cz]{font-weight: bold; font-size: 16px; color: green;}
            </style>
            <script type="text/javascript">
            //红色专家门诊 绿色普通门诊
            $(function(){
        ...
        <TR>
          ...
          <TD>
            <img style="width:300px; height:auto;" src="<?php echo ($info["qrcode"]); ?>">
          </TD>
        </TR>
        <TR>
          <TH valign="top">
            <label for="keyword">医生简介：</label>
          </TH>
          <TD>
            <?php echo ($info["info"]); ?>
          </TD>

...
<div class="msgWrap">
  <form class="form" method="post" action="<?php echo U('Hospital/insert');?>" enctype="multipart/form-data" >
		...
		<TR>
          ...
          <TD>
            <select name="sid" id="sid" style="width:200px">
              ...
              <?php if(is_array($sname)): $i = 0; $__LIST__ = $sname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </TD>
        </TR>
      </THEAD>

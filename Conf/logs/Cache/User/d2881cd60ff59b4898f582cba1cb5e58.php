...
<style>
    .bloodsuger{width: 800px; border:solid #add9c0; border-width:1px 0px 0px 1px; margin-top: 5px;}
    ...
    .xtjl{color:red;}
    .cdul li{display: inline-block; width: 200px;}
    .cdul li img{width: 100%;}
</style>
...
<div class="msgWrap">
  <TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
    ...
    <tr>
      <th style="font-size:15px; color:red;">基本信息</th>
    </tr>
    <TR>
      <TH valign="top">
        <label for="keyword">患者姓名：</label>
      </TH>
      <TD><?php echo ($info["name"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">性别：</label>
      </TH>
      <TD>
        <?php if($info["sex"] == 1): ?>男
          <?php else: ?>
    ...
    <TR>
      <TH valign="top">
        <label for="keyword">年龄：</label>
      </TH>
      <TD><?php echo ($info["age"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">患者电话：</label>
      </TH>
      <TD><?php echo ($info["tel"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">地址：</label>
      </TH>
      <TD><?php echo ($info["address"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">糖尿病类型：</label>
      </TH>
      <TD><?php echo ($info["diabetes"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">关注医生：</label>
      </TH>
      <TD><?php echo ($info["doctor"]["name"]); ?></TD>
    </TR>
    <tr>
      <th style="font-size:15px; color:red;">血糖详情</th>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <th style="font-size:15px; color:red;">重要指标</th>
    </tr>
    <TR>
      <TH valign="top">
        <label for="keyword">糖化血红蛋白(HbA1c):</label>
      </TH>
      <TD class="xtjl"><?php echo ($bprotein["hbaic"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">BMI:</label>
      </TH>
      <TD class="xtjl"><?php echo ($bprotein["bmi"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">血压(mmHg):</label>
      </TH>
      <TD class="xtjl"><?php echo ($bprotein["presure"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">甘油三脂(mmol/L):</label>
      </TH>
      <TD class="xtjl"><?php echo ($bprotein["xiezhi"]); ?></TD>
    </TR>
    <TR>
      <TH valign="top">
        <label for="keyword">用药情况:</label>
      </TH>
      <TD class="xtjl"><?php echo ($bprotein["note"]); ?></TD>
    </TR>
    <tr>
      <th style="font-size:15px; color:red;">化验单</th>
    </tr>
    <tr>
      <td colspan="2">
        <ul class="cdul">
          <?php if(is_array($laboratory)): $i = 0; $__LIST__ = $laboratory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li>
            <a href="<?php echo ($list["pic"]); ?>" target="_blank"><img src="<?php echo ($list["pic"]); ?>"></a>

...
<div class="msgWrap">
  <form class="form" method="post" action="<?php echo U('Salesman/upsave');?>" enctype="multipart/form-data" >
    <TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
     <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
      <THEAD>
        <TR>
          <TH valign="top">
            <span class="red">*</span><label for="keyword">销售姓名：</label>
          </TH>
          <TD>

    ...
    <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
      ...
      <TBODY>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php if(($list["status"]) == "1"): ?><span style="color:green">已处理</span><?php else: ?><span style="color:red">未处理</span><?php endif; ?></td>
            <td class="norightborder"> 
              <?php if(($list["status"]) == "0"): ?><a onclick="return confirm('确定已完成处理么？');" href="<?php echo U('Feedback/handleInfo',array('id'=>$list['id']));?>" title="查看详细">处理完成</a><?php endif; ?>
            </td>

...
<li class="current tabli" id="tab2"><a href="<?php echo U('Store/banner',array('token'=>$token));?>">轮播图管理</a></li>
...
<a href="<?php echo U('Store/bannerAdd', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加轮播图</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><img src="<?php echo ($hostlist["picurl"]); ?>" width="100"></td>
<td><?php echo ($hostlist["url"]); ?></td>
<td><?php echo ($hostlist["sort"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$hostlist["addtime"])); ?></td> 
<td class="norightborder">
	<a href="<?php echo U('Store/bannerSet',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/bannerDel',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
</td>

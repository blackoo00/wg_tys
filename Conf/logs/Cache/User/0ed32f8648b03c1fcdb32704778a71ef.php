	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td>
				<div class="mr15 l">
				<select name="type">
					<option value="click">关键词推送</option>
					<option value="view">外链跳转</option>
					<option value="scancode_waitmsg">扫描带提示</option>
		...
		<tr bgcolor="#F1F1F1">
			...
			<td>
				<div class="mr15 l"><input id="menu_keyword" class="txt" name="keyword" title="关联关键词" value="" type="text"></div>
				<div class="system l"></div>
			</td>
		</tr>
		<tr>

...
<div class="cLine">
  <div class="pageNavigator left">
    <a href='<?php echo U("Hospital/add");?>' title='新增医院' class='btnGrayS vm bigbtn'>
...
<div class="msgWrap">
  <form method="post"  action="index.php?ac=importtxt&amp;id=9379&amp;wxid=gh_858dwjkeww5" id="info" >
    ...
    <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
      ...
      <TBODY>
        <TR></TR>
        <?php if(is_array($hospital)): $i = 0; $__LIST__ = $hospital;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list["name"]); ?></td>
            <td><?php echo ($list["doctornum"]); ?></td>
            <td><?php echo ($list["info"]); ?></td>
			<td><?php echo ($list["orderNums"]); ?>（<a href="<?php echo U('Store/orders',array('hid'=>$list['id']));?>" style="color:blue">明细</a>）</td>
            <td class="norightborder"> <a href="<?php echo U('Hospital/edit',array('id'=>$list['id']));?>" title="编辑文本">编辑</a> <a onclick="return confirm('确定要删除么？');" href="<?php echo U('Hospital/del',array('id'=>$list['id']));?>">删除</a></td>

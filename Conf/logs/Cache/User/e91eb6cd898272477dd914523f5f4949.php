...
<div class="cLine">
  <div class="pageNavigator left">
    <a href='<?php echo U("Salesman/add");?>' title='新增销售' class='btnGrayS vm bigbtn'>
    ...
    <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
      ...
      <TBODY>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($list["hospitalnum"]); ?></td>
            <td><?php echo ($list["info"]); ?></td>
            <td class="norightborder"> <a href="<?php echo U('Salesman/edit',array('id'=>$list['id']));?>" title="编辑文本">编辑</a> <a onclick="return confirm('确定要删除么？');" href="<?php echo U('Salesman/del',array('id'=>$list['id']));?>">删除</a></td>

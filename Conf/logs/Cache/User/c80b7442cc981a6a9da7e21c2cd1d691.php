		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<tr class="tenpay" <?php if($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
					<th>版本：</th>
					<td><select name="version"><option value="0" <?php if(($config["version"]) == "0"): ?>selected<?php endif; ?>>旧版</option><option value="1" <?php if(($config["version"]) == "1"): ?>selected<?php endif; ?>>新版</option></select></td>
				</tr>
				<tr class="tenpay" <?php if($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
					<th>商户号：</th>
					<td><input type="text" name="mchid" value="<?php echo ($config["mchid"]); ?>" class="px" style="width:350px;"></td>
				</tr>
				<tr class="tenpay" <?php if($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
					<th>appId：</th>

...
+ function($) {
  ...
  $.textarea = function(text, title, callbackOK, callbackCancel) {
    if (typeof title === 'function') {
      callbackCancel = arguments[2];
      callbackOK = arguments[1];
      title = undefined;
    ...
    return $.modal({
      text: "<p class='weui-prompt-text'>"+(text || "")+"</p><textarea type='text' class='weui_textarea weui-prompt-textarea' id='weui-prompt-textarea'></textarea>",
      title: title,
      buttons: [
      {
        text: defaults.buttonCancel,
      ...
      },
      {
        ...
        className: "primary",
        onClick: function() {
          callbackOK && callbackOK($("#weui-prompt-textarea").val());
        }
      }]
    });
  };
